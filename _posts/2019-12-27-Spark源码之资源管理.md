...
![image.png]({{ site.url }}/assets/spark_deploy_1_1.png)
...
![image.png]({{ site.url }}/assets/spark_deploy_1_3.png)
...
![image.png]({{ site.url }}/assets/spark_deploy_1_2.png)
...
![image.png]({{ site.url }}/assets/spark_deploy_1_4.png)
...
![image.png]({{ site.url }}/assets/spark_deploy_1_6.png)

#### client mode

client 模式 driver 在client中执行。 程序首先加载用户启用主类作为启动类。

![image.png]({{ site.url }}/assets/spark_deploy_1_5.png)
...
![image.png]({{ site.url }}/assets/spark_deploy_1_7.png)
...
![image.png]({{ site.url }}/assets/spark_deploy_1_8.png)
